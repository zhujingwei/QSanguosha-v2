...
return {
    ...
    ["qingjian"] = "清俭" ,
    [":qingjian"] = "当你于摸牌阶段外获得牌后，你可将其中任意张牌置于武将牌上，若如此做，此回合结束后，你将武将牌上的所有牌交给其他角色。",
    ["@qingjian"] = "你可以将至多 %arg 张手牌置于武将牌上" ,
    ["@qingjian-distribute"] = "请将清俭置于武将牌上的牌任意分配" ,
    ["~qingjian"] = "选择任意张置于武将牌上的牌-选择一名角色-点击“确定”" ,
	...
	["rende"] = "仁德",
	[":rende"] = "出牌阶段，你可以将任意张手牌交给一名本阶段未获得过“仁德”牌的其他角色。当你于本阶段给出第二张“仁德”牌时，你可以视为使用一张基本牌。",
	["@rende-basic"] = "你可以视为使用一张【%arg】",
    ["rende-basic"] = "仁德",
	["jijiang"] = "激将",
