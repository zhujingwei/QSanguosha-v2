...
return {
    ...
    ["#sunluyu"] = "舍身饲虎",
    ["meibu"] = "魅步" ,
    [":meibu"] = "一名其他角色的出牌阶段开始时，若你不在其攻击范围内，你可以令该角色获得技能“止息”直到回合结束（锁定技，你使用了一张锦囊牌后，你的锦囊牌均视为【杀】）。若如此做，则直到回合结束，视为你在其攻击范围内。" ,
    [":meibu-removelast"] = "一名其他角色的出牌阶段开始时，若你不在其攻击范围内，你可以令该角色获得技能“止息”直到回合结束（锁定技，你使用了一张锦囊牌后，你的锦囊牌均视为【杀】）。" ,
    ["mumu"] = "穆穆" ,
    [":mumu"] = "出牌阶段限一次，你可以弃置一张牌，然后选择一项：弃置场上的一张装备牌，然后摸一张牌；或获得场上的一张防具牌。若你以此法弃置的牌是【杀】或黑色锦囊牌，则直到你的下个回合开始，去掉技能“魅步”中的最后一句描述。" ,
    ["mumu:get_armor"] = "获得一张防具牌",
    ["mumu:dis_equip"] = "弃置一张装备牌然后摸一张牌",
    ["zhixi"] = "止息",
    [":zhixi"] = "锁定技，你使用了一张锦囊牌后，你的锦囊牌均视为【杀】。",
    ...
    ["jili"] = "寄篱",
    [":jili"] = "锁定技，当其他角色成为红色基本牌或红色普通锦囊牌的目标时，若其与你的距离为1且你既不是此牌的使用者也不是目标，你也成为此牌的目标。",
